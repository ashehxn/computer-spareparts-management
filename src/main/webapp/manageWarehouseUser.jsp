                        ...
                        <tbody>
                           <c:forEach var="warehouseUsers" items="${warehouseUsers}">
								...
								<tr>
									...
									<td>
										<a href="WarehouseUserEditServlet?id=<c:out value='${warehouseUsers.staffId}' /> ">Edit</a>
										<a href="WarehouseUserDeleteServlet?id=<c:out value='${warehouseUsers.staffId}'/> ">Delete</a>
									</td>
								</tr>
