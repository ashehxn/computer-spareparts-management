    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="cardBox twoCardBox">
                <div class="card">
                	<a href="ShowShopUsers" style="text-decoration: none">
                		<div>
	                        <div class="numbers">Manage Shop Managers</div>
	                        <div class="cardName">Manage shop managers</div>
	                    </div>
                	</a>
                </div>
                ...
                <div class="card">
                    <div>
                    	<a href="ShowWarehouseUsers" style="text-decoration: none">
	                		<div class="numbers">Manage Warehouse Users</div>
                        	<div class="cardName">Manage warehouse managers and employees</div>
	                	</a>
                    </div>
                </div>
            </div>
