        ...
        <div class="main">
            ...
            <div class="form">
            	<div class="formRows">
	            	...
	            	<h2>Enter Warehouse User Details</h2>
	                <form action="WarehouseUserInsertServlet" method="post">
						...
						<h4>Type: </h4>
						<div class="inputContainer">
							<select name="userType" class="inputField" required>
								<option value="WarehouseM">WarehouseM</option>
								<option value="WarehouseE">WarehouseE</option>
							</select>
						</div>
						
						<h4>Warehouse ID: </h4>
						<div class="inputContainer">
							<input type="number" name="warehouseId" class="inputField" required><br>
						</div>
